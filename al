...
addWeekNumber(4, 1, 14);
addWeekNumber(4, 2, 15); // Kjøkken stue entre
addWeekNumber(4, 3, 16); // Søppel
addWeekNumber(4, 4, 17); // Bad
addWeekNumber(4, 5, 18); // Kjøkken stue entre
addWeekNumber(4, 6, 19); // Søppel
